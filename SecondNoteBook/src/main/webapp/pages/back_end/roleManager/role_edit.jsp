	 ...
	 <div class="row col-md-12">
	  <form class="form-horizontal" id="editTypeForm">
	            <div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" id="typeNameId"  placeholder="角色名称" class="form-control dynamicClear required">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2 control-label">上级角色：</div>
					<div class="col-sm-10">
						<input type="text" id="parentNameId" readonly="readonly" placeholder="选择角色"
							class="form-control required dynamicClear load-product-type" style="cursor: pointer;">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2 control-label">角色序号：</div>
					<div class="col-sm-10">
...
<script type="text/javascript" src="${basePath}/static/js/back_end/role_edit.js"></script>
